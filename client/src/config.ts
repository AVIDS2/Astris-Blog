...
export const siteConfig: SiteConfig = {
	title: "Astris",
	subtitle: "The Will of Freedom",
	siteURL: "https://dwill.top/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-01-08", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		src: {
			desktop: [
				...
				"/assets/desktop-banner/sky.jpg",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/ishaan.jpg",
				"/assets/mobile-banner/moon.jpg",
				"/assets/mobile-banner/rock.jpg",
				"/assets/mobile-banner/sky.jpg",
			], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/631853247",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: ["/pio/models/whitecat/sdwhite cat free.model3.json"], // 白猫娘模型
	position: "right", // 右下角
	width: 300, // 适配新模型的尺寸
	height: 400,
	mode: "draggable",
	...
	dialog: {
		...
		home: "点击这里回到首页！",
		skin: ["想看我的新衣服吗？", "新衣服很好看哦~"],
		close: "QWQ 下次再见~",
		link: "https://github.com/AVIDS2",
		timeGreetings: {
			morning: ["早上好呀~ ☀️ 今天也要元气满满哦！", "おはよう～早起的鸟儿有虫吃！"],
			noon: ["中午好~ 🍱 记得吃午饭哦！", "午安~ 别忘了休息一下眼睛~"],
			afternoon: ["下午好~ ☕ 来杯下午茶吧！", "下午啦~ 继续加油！"],
			evening: ["晚上好~ 🌙 今天过得怎么样？", "晚上好呀~ 别太晚睡哦~"],
			lateNight: ["这么晚了还不睡吗？💤", "夜深了喵~ 注意身体不要熬夜！", "凌晨了哦...该睡觉了吧？"],
		},
		idle: [
			"在认真看博客吗？很开心呢~",
			"无聊了吗？要不要逛逛其他文章？",
